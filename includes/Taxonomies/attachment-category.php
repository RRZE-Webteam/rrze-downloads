...
define(__NAMESPACE__ . '\TAXONOMY', \RRZE\Downloads\Config::get('attachment_category_taxonomy'));

function set() {
    $labels = array(
        'name' => __('Categories', 'rrze-downloads'),
        'singular_name' => __('Category', 'rrze-downloads'),
        'search_items' => __('Search Categories', 'rrze-downloads'),
        'all_items' => __('All Categories', 'rrze-downloads'),
        'parent_item' => __('Parent Category', 'rrze-downloads'),
        'parent_item_colon' => __('Parent Category:', 'rrze-downloads'),
        'edit_item' => __('Edit Category', 'rrze-downloads'),
        'update_item' => __('Update Category', 'rrze-downloads'),
        'add_new_item' => __('Add New Category', 'rrze-downloads'),
        'new_item_name' => __('Name', 'rrze-downloads'),
        'menu_name' => __('Categories', 'rrze-downloads')
    );
...
function filter_list() {
    ...
    if ($screen->parent_file == 'upload.php' && get_terms(TAXONOMY)) {
        wp_dropdown_categories(array(
            'show_option_all' => __('All Categories', 'rrze-downloads'),
            'taxonomy' => TAXONOMY,
            'name' => TAXONOMY,
            'orderby' => 'name',
