...
class Shortcode
{
    ...
    public function onLoaded()
    {
        ...
        add_shortcode('downloads', [$this, 'downloadsShortcode'], 10, 2);
    }
    ...
    {
        wp_register_style('downloads-shortcode', plugins_url('assets/css/shortcodes/downloads-shortcode.min.css', plugin_basename($this->pluginFile)));
        wp_register_script('downloads-shortcode', plugins_url('assets/js/shortcodes/downloads-shortcode.min.js', plugin_basename($this->pluginFile)));
    }
     ...
     */
    public function downloadsShortcode($atts, $content = '')
    {
        ...
        if ($display) {
            // $output = '<span class="downloads-shortcode downloads-shortcode-display" data-display="true">[shortcode display]</span>';
            $args = shortcode_atts(
                array(
                    "category" => '',
                    "cat" => '',
            ...
            $output = '<span class="downloads-shortcode" data-display="false">[shortcode hidden]</span>';
        }

        wp_enqueue_style('downloads-shortcode');
        wp_enqueue_script('downloads-shortcode');
